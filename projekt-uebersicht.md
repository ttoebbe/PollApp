...
graph TD
    subgraph Bootstrap
        ...
        routes["<b>app.routes.ts</b><br/>• 3 Pfade definiert<br/>• '' → Home<br/>• 'survey/:id' → Detail<br/>• 'create' → CreateSurvey"]
    ...
    subgraph Pages
        ...
        detail["<b>survey-detail.ts</b><br/>• Detailseite<br/>• liest :id aus ActivatedRoute<br/>• Vote-Karte + Results-Karte<br/>• localStorage-Check gegen Doppelabstimmung"]
